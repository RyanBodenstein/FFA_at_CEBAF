...
\begin{figure*}[!tbh]
    ...
    \caption{Mean percentage change in magnetic moment for each material grade. Error bars: ${\pm}1$ SEM. The NdFeB--SmCo differential is the gain-immune headline result.}
    \label{fig:materials}
    \vspace{-12pt}
\end{figure*}
