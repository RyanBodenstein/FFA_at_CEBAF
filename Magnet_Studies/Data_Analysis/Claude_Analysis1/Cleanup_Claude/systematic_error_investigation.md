...
- **Alderman et al. (ANL)** irradiated Nd-Fe-B samples with APS bending magnet
  synchrotron radiation (pure gamma, no neutron component) to cumulative doses up to
  **700 Mrad (7 MGy)** and observed **no measurable demagnetization**. This is the
  highest-dose gamma-only null result in the literature for NdFeB.
...
(ρ = 0.21, p = 0.27), consistent with the Alderman et al. null result at 7 MGy of
pure gamma irradiation and with the established dominance of neutron-induced damage
