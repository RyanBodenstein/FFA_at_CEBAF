...
def load_lab_y_plates(apply_temp_correction=True):
    ...
    for plate_num in LAB_Y_PLATES:
        ...
        for slot in [1, 2, 3, 4]:
            ...
            slot_mwc[mat] = {
                'baseline_mwc': bl_corr if (apply_temp_correction and mat in Y_ALPHA) else baseline_val,
                'latest_mwc': lt_corr if (apply_temp_correction and mat in Y_ALPHA) else latest_val,
            }
