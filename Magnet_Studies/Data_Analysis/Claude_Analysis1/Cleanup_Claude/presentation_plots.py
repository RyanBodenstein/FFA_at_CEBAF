...
def plot_P15_literature_comparison(intra_diffs, gain_syst):
    ...
    Approximate values are sufficient for context — see Samin (2018)
    ...
    #
    # Alderman et al. (2002) NIM A 481: multi-source study (ANL/ORNL/NIST)
    #   60Co gamma null at 700 Mrad (7 MGy); X-ray null at 280 Mrad (2.8 MGy)
    #   Fast neutrons: 0.6% at 2.33e13 n/cm2 (fluence, not Gy — not plotted)
    #
    # Miyahara et al. (2010) NIM B 268: 10 MeV neutron beam (d-Be)
    #   0.6% at 1.1 kGy, 6.9% at 3.7 kGy, 47.3% at 7.4 kGy
    #
    ...
    # Alderman (2002) — 60Co gamma null
    ax_lit.scatter(7e6, 1, marker='X', c='#2A9D8F', s=200,
                   edgecolor='black', linewidth=1.2, zorder=5)
    ax_lit.annotate('Alderman (2002)\n⁶⁰Co γ null, 7 MGy',
    ...
    # Alderman (2002) — X-ray null (APS bending magnet)
    ax_lit.scatter(2.8e6, 1.5, marker='X', c='#2A9D8F', s=150,
                   edgecolor='black', linewidth=1.2, zorder=5)
    ax_lit.annotate('X-ray null\n2.8 MGy',
                    xy=(2.8e6, 1.5), xytext=(-15, 15),
                    textcoords='offset points', ha='right', va='bottom',
                    fontsize=7.5, color='#2A9D8F')
    ax_lit.annotate('', xy=(2.8e6, 0), xytext=(2.8e6, 1.5),
                    arrowprops=dict(arrowstyle='->', color='#2A9D8F', lw=1.2))

    # Miyahara et al. (2010) — 10 MeV neutron beam
    miy_doses = [1100, 3700, 7400]    # Gy
    miy_demag = [0.6, 6.9, 47.3]     # %
    ax_lit.scatter(miy_doses, miy_demag, marker='^', c='#D4380D', s=180,
                   edgecolor='black', linewidth=1.2, zorder=5)
    ax_lit.annotate('Miyahara (2010)\n10 MeV neutrons',
                    xy=(7400, 47.3), xytext=(15, 5),
                    textcoords='offset points', ha='left', va='bottom',
                    fontsize=8.5, fontweight='bold', color='#D4380D')
    ax_lit.annotate('47.3%%', xy=(7400, 47.3), xytext=(0, -12),
                    textcoords='offset points', ha='center', va='top',
                    fontsize=7.5, color='#D4380D')
    ax_lit.annotate('6.9%%', xy=(3700, 6.9), xytext=(10, 5),
                    textcoords='offset points', ha='left', va='bottom',
                    fontsize=7.5, color='#D4380D')
    ax_lit.annotate('0.6%%', xy=(1100, 0.6), xytext=(10, 5),
                    textcoords='offset points', ha='left', va='bottom',
                    fontsize=7.5, color='#D4380D')
    ...
    legend_elements = [
        ...
        Line2D([0], [0], marker='^', color='w', markerfacecolor='#D4380D',
               markersize=10, markeredgecolor='k', label='Fast neutrons'),
        Line2D([0], [0], marker='X', color='w', markerfacecolor='#2A9D8F',
               markersize=10, markeredgecolor='k', label='Photon-only (γ, X-ray)'),
    ...
    fig.text(0.5, -0.01,
             ...
             'See Samin (2018) J. Nucl. Mater. 503 for comprehensive review.',
             ha='center', fontsize=9, fontstyle='italic', color='gray')
