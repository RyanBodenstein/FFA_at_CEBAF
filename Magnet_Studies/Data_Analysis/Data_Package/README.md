...
**-0.208% +/- 0.027% (stat) — 7.7 sigma significance**
...
3. Downstream analyses:
   ```
   python3 presentation_plots.py          # P1-P14 presentation figures
...
- `1337` or `1337.0` in measurement data = no valid reading (sensor error or
  missing measurement)
- `0.0` in baseline_mean_mWC for lab plates = value not stored by lab loader
  (pct_change is still valid)
...
---
*Package generated 2026-04-01 by export_data_package.py*
