...
\begin{figure*}[!tbh]
    \centering
    \includegraphics*[trim=0.cm 0.0cm 0.0cm 0.0cm,clip,width=1.\textwidth]{IPAC26_f1.png}
    \caption{Mean percentage change in magnetic moment for each material grade. Tunnel Y-plates (blue) vs.\ lab controls (orange). Error bars: ${\pm}1$ SEM. The NdFeB--SmCo differential is the gain-immune headline result.}
    \label{fig:materials}
\end{figure*}
...
\begin{figure*}[!tbh]
    \centering
    \includegraphics*[trim=0.cm 0.0cm 0.0cm 0.0cm,clip,width=1.\textwidth]{IPAC26_f3.png}
...
In parallel, BDSIM/GEANT4 simulations~\cite{NEVAY:BDSIM, GEANT4, Gamage:IPAC24-THPS57, Gamage:NAPAC25-WEP074} of the CEBAF beamline are progressing toward predicting the neutron fluence and energy spectrum at each plate location, enabling first-principles comparison with the measured degradation. Once validated against the current CEBAF lattice, these simulations will be extended to the upgrade energies to predict FFA magnet lifetime.
...
In addition to those listed as co-authors, we would like to thank the CEBAF Radiation Control Group for dosimetry support, CEBAF Operations and Operability, and the Installation Group.
...
\ifboolexpr{bool{jacowbiblatex}}%
    ...
    \begin{thebibliography}{99}   % Use for  10-99  references
        ...
        \bibitem{GEANT4}
            ...
            in \emph{Nucl. Instrum. Methods Phys. Res. A}, vol.~506, no.~3, 2003, pp. 250--303.
        ...
        \bibitem{Gamage:NAPAC25-WEP074}
            ...
            in \emph{Proc. NAPAC'25}, Sacramento, CA, Aug. 2025, WEP074.
